...
{
    public class ToolTipHandler : IInitializable, ITickable
    {
        ...
        public void Activate(string headerText, string contentText, ToolTipPosition toolTipPosition)
        {
            _view.Show(headerText, contentText);
